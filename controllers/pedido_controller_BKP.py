...
def novo_pedido_cliente():
    ...
    form.data_entrega.choices = cardapio_model.busca_datas_entrega(date.today(), conn)
    ...
    try:
        produtos = {
            "id": produtos_cardapio_from_db[0],
            "produto": produtos_cardapio_from_db[1],
            "qtd_produto": produtos_cardapio_from_db[2],
            "preco_venda": produtos_cardapio_from_db[3],
            "descricao": produtos_cardapio_from_db[4]
        }
    except:
        produtos = {}
    ...
    if form.validate_on_submit():
        ...
        #     selected_products.append((product, int(request.form[product])))
    ...
    return render_template("pedido/novo_pedido_cliente.html",
                           form=form)
                           # cardapios=cardapios,
